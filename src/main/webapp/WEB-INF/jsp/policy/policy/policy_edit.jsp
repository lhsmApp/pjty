				...
				<div class="row">
					...
					<form action="policy/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">政策分类:</td>
								<td><input type="text" name="POLI_TYPE" id="POLI_TYPE" value="${pd.POLI_TYPE}" maxlength="100" placeholder="这里输入政策分类" title="政策分类" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input class="span10 date-picker" name="PUB_DATE" id="PUB_DATE" value="${pd.PUB_DATE}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="发布时间" title="发布时间" style="width:98%;"/></td>
							</tr>
							<tr>
